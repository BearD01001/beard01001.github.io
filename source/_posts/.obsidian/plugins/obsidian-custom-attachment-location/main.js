...
var require_Vault = __commonJS({
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/Vault.cjs"(exports2, module2) {
    ...
    async function deleteSafe(app, pathOrFile, deletedNotePath, shouldReportUsedAttachments, shouldDeleteEmptyFolders) {
      const file = (0, import_TAbstractFile4.getAbstractFileOrNull)(app, pathOrFile);
      if (!file) {
        return false;
      }
    ...
    async function listSafe(app, pathOrFolder) {
      const path = (0, import_TAbstractFile4.getPath)(pathOrFolder);
    ...
    async function isEmptyFolder(app, pathOrFolder) {
      const listedFiles = await listSafe(app, (0, import_TAbstractFile4.getPath)(pathOrFolder));
  ...
  "node_modules/obsidian-dev-utils/dist/lib/obsidian/RenameDeleteHandler.cjs"(exports2, module2) {
    ...
    var RenameDeleteHandler = class {
      ...
      async handleDelete(file) {
        ...
        const attachmentFolderPath = await (0, import_AttachmentPath5.getAttachmentFolderPath)(this.app, file.path);
        ...
        if (this.settingsBuilder().shouldDeleteOrphanAttachments) {
          await (0, import_Vault6.deleteSafe)(this.app, attachmentFolder, file.path, false, this.settingsBuilder().shouldDeleteEmptyFolders);
        }
      }
        ...
        try {
          ...
          if (oldFile) {
            ...
            if (this.settingsBuilder().shouldDeleteEmptyFolders) {
              await (0, import_Vault6.deleteEmptyFolderHierarchy)(this.app, oldFolder);
            }
          }
...
async function collectAttachments(plugin, note, oldPath, attachmentFilter) {
  ...
  for (const [oldPath2, newPath] of attachmentsMap.entries()) {
    ...
    if (backlinks.count() === 0) {
      ...
      await (0, import_Vault2.deleteEmptyFolderHierarchy)(app, oldAttachmentFolder);
    } else {
